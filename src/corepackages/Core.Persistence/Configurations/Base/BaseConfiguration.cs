    ...
    where TKey : struct, IEquatable<TKey>
{
    public virtual void Configure(EntityTypeBuilder<T> builder)
    {
        ...
        builder.Property(x => x.CreatedBy).HasColumnName("CreatedBy").IsRequired(true).HasMaxLength(LengthConstraints.CreatedByMaxLength).ValueGeneratedOnAdd();
        builder.Property(x => x.ModifiedBy).HasColumnName("ModifiedBy").IsRequired(false).HasMaxLength(LengthConstraints.CreatedByMaxLength);

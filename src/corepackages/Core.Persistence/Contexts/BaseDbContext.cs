...
public class BaseDbContext : DbContext
{
    ...
    public BaseDbContext(DbContextOptions<BaseDbContext> dbContextOptions, IConfiguration configuration, IHttpContextAccessor httpContextAccessor) : base(dbContextOptions)
    {
    ...
    {
        var entities = ChangeTracker.Entries().Where(x => x.Entity is Entity<Guid> && (x.State == EntityState.Added || x.State == EntityState.Modified));
